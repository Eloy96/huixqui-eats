    ...
    html`
      ...
      <div class="header-acciones">
        ${sesion
          ...
          : html`<a class="boton boton--chico" href="#/cuenta" style="background:var(--maiz-500);color:var(--verde-900);font-weight:var(--peso-fuerte)">Entrar</a>`}
      </div>
    `,
  );
...
function contenidoBarra(n) {
  return html`
    ...
    <span class="boton boton--chico" style="background:var(--maiz-500);color:var(--verde-900);pointer-events:none">
      ${dinero(totalCarrito())}
    </span>
  `;
}
